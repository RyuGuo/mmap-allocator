...
#include "usable_lib/conqueue.h"
#include "usable_lib/fatomic.h"
#include "usable_lib/lfbitset.h"
#include "usable_lib/seg_allocator.h"
#include <algorithm>
#include <atomic>
#include <cstdint>
#include <cstdio>
  ...
  for (uint64_t i = 0; i < chunk_num; ++i) {
    ...
    if (!layout.free_chunk_bitset->test(
      ...
      case tHUGE: {
        ...
        global_pool->huge_chunk_allocator.placement_allocate(i,
                                                             alloc_chunk_num);
        i += alloc_chunk_num - 1;
      } break;
      }
